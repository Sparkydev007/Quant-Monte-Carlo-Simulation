...
![Python](https://img.shields.io/badge/Python-%3E%3D3.10-3776AB.svg?style=flat&logo=python)
![NumPy](https://img.shields.io/badge/NumPy-1.x-0F4C81.svg?style=flat&logo=numpy)
![SciPy](https://img.shields.io/badge/SciPy-1.x-8CAAE6.svg?style=flat&logo=scipy)
![Matplotlib](https://img.shields.io/badge/Matplotlib-3.x-FF6F00.svg?style=flat&logo=matplotlib)
![Quant Finance](https://img.shields.io/badge/Quant%20Finance-Monte%20Carlo-111827.svg?style=flat)
![License](https://img.shields.io/badge/License-MIT-green.svg?style=flat)
Simulation Output Preview
![Console Output](assets/results-console.png)
...
[
\mathbf{Z}{corr} = \mathbf{Z}{ind} L^\top,
...
[
\mathrm{VaR}{\alpha} = \mathrm{Quantile}{\alpha}(\mathrm{Loss})
]
CVaR (Expected Shortfall) at (\alpha):
[
\mathrm{CVaR}{\alpha} = \mathbb{E}[\mathrm{Loss};\mid;\mathrm{Loss}\ge \mathrm{VaR}{\alpha}]
]
